...
public class Url {
    public static String IP = "http://62.234.20.192/tuangou/api/service/shop";
    ...
    //上传图片
    public static String uploadFile = "http://62.234.20.192/tuangou/api/common/fileUpload"; //file   url:""//图片链接
