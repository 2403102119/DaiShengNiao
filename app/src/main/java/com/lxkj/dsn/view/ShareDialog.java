...
public class ShareDialog extends Dialog {
    ...
    public ShareDialog(Context context,  boolean isCan) {
        ...
        TextView tvPyq = findViewById(R.id.tvPyq);
        ...
        tvWx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                dismiss();
                listener.OnConfirmClick("wx");
            }
        });
        tvPyq.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                dismiss();
                listener.OnConfirmClick("pyq");
            }
        });
    }
