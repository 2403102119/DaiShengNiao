 ...
 * @since 2019/12/21
 */
public class NoLoopBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public NoLoopBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
//            setPageTransformer(true, transformer.newInstance());
     ...
     * @return NoBanner
     */
    public NoLoopBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
