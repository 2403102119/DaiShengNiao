...
import com.lxkj.dsn.bean.MessageWrap;
...
public class WsManager implements IWsManager {
    ...
    private WebSocketListener mWebSocketListener = new WebSocketListener() {
        ...
        public void onMessage(WebSocket webSocket, final String text) {
            ...
            Log.e("websocket", "WsManager-----onMessage"+text);
            if (Looper.myLooper() != Looper.getMainLooper()) {
                wsMainHandler.post(new Runnable() {
                    @Override
                    public void run() {
                        if (text.equals("PONG")){
                            ...
                            map.put("cmd","19");
                            map.put("fromUserId","");
                            map.put("userId",SharePrefUtil.getString(mContext, AppConsts.UID, ""));
                            map.put("pageNo","1");
                            map.put("pageSize","10");
                            map.put("type","1");
                            ...
                            EventBus.getDefault().postSticky(MessageWrap.getInstance(text));
                        }
                    }
                });
            } else {
