...
//            tvAddress.setText(dataListBean.province_city_town);
//            etPhone.setText(dataListBean.phone);
//            etAddressDetail.setText(dataListBean.address);
//            addressId = dataListBean.id;
//            type = "0";
//        } else {
...
//        params.put("province_city_town", tvAddress.getText().toString());
...
//        mOkHttpHelper.post_json(getContext(), Url.editAddress, params, new SpotsCallBack<ResultBean>(getContext()) {
//            @Override
//            public void onSuccess(Response response, ResultBean resultBean) {
//                ToastUtil.show(resultBean.getResultNote());
//                act.finishSelf();
